...
\begin{mathpar}
  ...
  \inferrule{
    G_{t_i}(\e_i{=}(u_i, v, p, v_{G_{t_i}})) = \Plus \\
    \defaultpos{k} = p_k
  }{
    \act{v}{p}{
      \cursor{\conflictHoleForm{t_i}{i \leq n}}
      ...
      \graphAction{\Minus}{\e_1};
      \ldots;
      \graphAction{\Minus}{\e_n};
    } \\
    \graphAction{\Plus}{(\fresh{u}_1, (\fresh{u}_2, k), p_k, v_{G_{t_1}})};
    \ldots;
    \graphAction{\Plus}{(\fresh{u}_{2n-1}, (\fresh{u}_{2n}, k), p_k, v_{G_{t_n}})};
