...
\begin{mathpar}
  \inferrule{
    \act{v_{(\eFun{G}{\Z{q}}{\tau}{e})}}{\LamParam}{
      \Z{q}
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\eFun{G}{q}{\Z{\tau}}{e})}}{\LamType}{
      \Z{\tau}
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\eFun{G}{q}{\tau}{\Z{e}})}}{\LamBody}{
      \Z{e}
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{\eApp{G}{\Z{e}_1}{e_2}}}{\AppFun}{
      \Z{e}_1
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{\eApp{G}{e_1}{\Z{e}_2}}}{\AppArg}{
      \Z{e}_2
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\ePlus{G}{\Z{e}_1}{e_2})}}{\PlusLeft}{
      \Z{e}_1
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\ePlus{G}{e_1}{\Z{e}_2})}}{\PlusRight}{
      \Z{e}_2
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\eTimes{G}{\Z{e}_1}{e_2})}}{\TimesLeft}{
      \Z{e}_1
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\eTimes{G}{e_1}{\Z{e}_2})}}{\TimesRight}{
      \Z{e}_2
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\tArrow{G}{\Z{\tau}_1}{\tau_2})}}{\ArrowArg}{
      \Z{\tau}_1
    }{
      \alpha
    }{
  ...
  \inferrule{
    \act{v_{(\tArrow{G}{\tau_1}{\Z{\tau}_2})}}{\ArrowResult}{
      \Z{\tau}_2
    }{
      \alpha
    }{
  ...
  \inferrule{
    ...
    \act{v}{p}{
      \conflictHoleForm{\Z{t}; t_i}{i \leq n}
    }{
     \alpha
    }{
      a^{*}
...
\begin{mathpar}
  ...
  \inferrule{
    ...
    \act{v}{p}{
      ...
      \big(\Minus, \e\big);
      \graphAction{\Plus}{(u', v, p, (u'', k))};
      \graphAction{\Plus}{(u''', (u'', k), p_k, v_t)}
    }
  }
  ...
  \inferrule{
    ...
    \act{v}{p}{
      ...
      \graphAction{\Minus}{(u_1, v, p, v_{t_1})};
      \ldots;
      \graphAction{\Minus}{(u_n, v, p, v_{t_n})};
      \graphAction{\Plus}{(u, v, p, (u', k))};
    } \\
    \graphAction{\Plus}{(u_1', (u', k), p_k, v_{t_1})};
    \ldots;
    \graphAction{\Plus}{(u_n', (u', k), p_k, v_{t_n})}
  }
  ...
  \inferrule{
    ...
    \act{v}{p}{
      \cursor{\multiVertex{\e{=}(u, v, p, v')}}
    }{
      \Construct{k}
    }{
      \big(\Minus, \e\big);
      \graphAction{\Plus}{(u', v, p, (u'', k))};
      \graphAction{\Plus}{(u''', (u'', k), p_k, v')}
    }
  }
  ...
  \inferrule{
    ...
    \act{v}{p}{
      \multiVertex{\e{=}(u, v, p, v')}
    }{
      \Reposition{v_\alpha}{p_\alpha}
    }{
      \big(\Minus, \e\big);
      \big(\Plus, (u_1, v_\alpha, p_\alpha, v')\big)
    }
  }
...
% TODO: conflict holes { t^ | { t_i }_i<n }
% TODO: use above subscript syntax everywhere
% TODO: try descriptive (or numeric) subscripts for fresh u's
% TODO: change ...'s to subscript notation in action semantics
% TODO: turn premise-less rule into axiom (add line of inference)

% \noindent $\boxed{\Z{e} \userAction{\alpha} \Z{e}}$
% %
% \begin{align*}
%   \cursor{v}{p}{\hole}   \userAction{\Construct{k}}   \cursor{v}{p}{\decomp{(u, v, p, (u', k)}} \\
%   \cursor{v}{p}{}
% \end{align*}
