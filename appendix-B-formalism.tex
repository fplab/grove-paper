    ...
    \item $t = \conflictHole{t_1, \ldots, t_n}$ and all of the following hold:
      \begin{enumerate}
        ...
        \item
          ...
          % NOTE: is it possible for them to all have the same-but-wrong source vertex and position?
      \end{enumerate}
...
\noindent $\boxed{\Z{t} \action{\alpha} a^{*}}$
%
\begin{mathpar}
  \inferrule{
    \Z{q} \action{\alpha} a^{*}
  ...
  \inferrule{
    \Z{t_1} \action{\alpha} a^{*}
  }{
    \conflictHole{\Z{t_1}, t_2, \ldots, t_n}
    \action{\alpha}
    a^{*}
  }
\end{mathpar}
...
\begin{mathpar}
  ...
  \inferrule{
    ...
    \cursor{v}{p}{\conflictHole{t_1, \ldots, t_n}}
    \action{\Construct{k}}
    \big(\Plus, (u, v, p, (u', k))\big)
  }
  ...
  \inferrule{
    ...
    \cursor{v}{p}{\conflictHole{t_1, \ldots, t_n}}
    \action{\Construct{k}}
    \big(\Minus, (u_1, v, p, v_1')\big);
    \ldots;
    \big(\Minus, (u_n, v, p, v_n')\big);
    \big(\Plus, (u, v, p, (u', k))\big); \\
    \big(\Plus, (u_1', (u', k), p_k, v_1')\big);
    \ldots;
    \big(\Plus, (u_n', (u', k), p_k, v_n')\big)
  }

  \inferrule{
    \defaultpos{k} \text{ undefined}
  }{
    \cursor{v}{p}{\multiVertex{(u, v, p, v')}}
    \action{\Construct{k}}
    \big(\Plus, (u', v, p, (u'', k))\big)
  }
  ...
  \inferrule{
    ...
    \cursor{v}{p}{\multiVertex{\e{=}(u, v, p, v')}}
    \action{\Construct{k}}
    \big(\Minus, \e\big);
    \big(\Plus, (u', v, p, (u'', k))\big);
  ...
  \inferrule{
    ...
    \cursor{v}{p}{\cycleVertex{(u, v, p, v')}}
    \action{\Construct{k}}
    \big(\Plus, (u', v, p, (u'', k))\big)
  }
  ...
  \inferrule{
    ...
    \cursor{v}{p}{\cycleVertex{\e{=}(u, v, p, v')}}
    \action{\Construct{k}}
    \big(\Minus, \e\big);
    \big(\Plus, (u', v, p, (u'', k))\big);
    \big(\Plus, (u''', (u'', k), p_k, v')\big)
