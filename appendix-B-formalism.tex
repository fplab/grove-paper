...
\begin{mathpar}
  \inferrule{
    \applyAction{ \Z{\Set}_{NP} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\Z{\Set}_{NP}, \Set[MP], \Set[U]) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{\Set}_{MP} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\Set[NP], \Z{\Set}_{MP}, \Set[U]) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{\Set}_U }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\Set[NP], \Set[MP], \Z{\Set}_U) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }
\end{mathpar}
...
\begin{mathpar}
  \inferrule{
    \applyAction{ \Z{t} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\Set, \Z{t}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }
\end{mathpar}

\noindent $\boxed{\applyAction{ \Z{t} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }}$
%
\begin{mathpar}
  \inferrule{
    \applyAction{ \Z{q} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\eFun{G}{\Z{q}}{\tau}{e}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{\tau} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\eFun{G}{q}{\Z{\tau}}{e}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\eFun{G}{q}{\tau}{\Z{e}}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e}_1 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ \eApp{G}{\Z{e}_1}{e_2} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e}_2 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ \eApp{G}{e_1}{\Z{e}_2} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e}_1 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\ePlus{G}{\Z{e}_1}{e_2}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e}_2 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\ePlus{G}{e_1}{\Z{e}_2}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e}_1 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\eTimes{G}{\Z{e}_1}{e_2}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{e}_2 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\eTimes{G}{e_1}{\Z{e}_2}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{\tau}_1 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\tArrow{G}{\Z{\tau}_1}{\tau_2}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{\tau}_2 }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ (\tArrow{G}{\tau_1}{\Z{\tau}_2}) }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }

  \inferrule{
    \applyAction{ \Z{t} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }{
    \applyAction{ \conflictHole{\Z{t}, \SetOf{t_i}_{i \leq n}} }{ v }{ p }{ \alpha }{ \Q{a} }{ v' }{ p' }
  }
\end{mathpar}
%
\begin{mathpar}
  \inferrule[Construct]{
    ...
    \applyAction{ \cursor{\emptyHole{v_s{=}(u_s, k_s)}{p_s}} }{ v_s }{ p_s }{ \Construct{k} }{
      % 
  ...
  \inferrule[ConstructWrap]{
    ...
    % 
    % 3. The new constructor and the inconstructor of t (k_Gt) have the same sort
    \sort{k} = \sort{k_{G_t}} \\
    % 
    % 4. The new (default) position and old sort are in the arity of the new constructor
    (\pWrap, \sort{k_{G_t}}) \in \arity{k} \\\\
    % 
    % And we let:
    % 
    % v_k = a new vertex with the new constructor
    ...
    % 
    % e' = a new edge from the new vertex and default position to the old invertex
    \e' = (\fresh{u}, v_k, \pWrap, v_{G_t})
  }{
    % Then the user action Construct(k) produces the following set of graph actions:
    \applyAction{ \cursor{t} }{ v_s }{ p_s }{ \Construct{k} }{
      % 
      % delete the old ingraph
      \SetOf{\graphAction{\Minus}{\e}}_{\e \in \inedges{G_t}} \cup
      % 
  ...
  \inferrule[Delete]{
    ...
    % 
    % 1. The term under the cursor (t) has an ingraph (Gt)
    \inedges{G_t} = \SetOf{\e_i{=}(u_i, v_{s_i}, p_{s_i}, v_{G_t})}_{i \leq n} \\
  }{
    % Then the user action Delete produces the following set of graph actions:
    \applyAction{ \cursor{t} }{ v_s }{ p_s }{ \Delete }{
      % 
      % delete the ingraph
  ...
  \inferrule[Reposition]{
    ...
    % 
    % 1. The term under the cursor (t) has an ingraph (Gt)
    \inedges{G_t} = \SetOf{\e_i}_{i \leq n} \\
    % 
    % 2. The new source vertex (v) has no children at position (p)
    \children{v}{p} = \varnothing \\
    % 
    ...
    \applyAction{ \cursor{t} }{ v_s }{ p_s }{ \Reposition{v{=}(u, k)}{p} }{
      % 
      % delete the old ingraph
      \SetOf{\graphAction{\Minus}{\e_i}}_{i \leq n} \cup
      % 
      % attach the old invertex to the new parent
      \SetOf{\graphAction{\Plus}{(\fresh{u}, v_s, p_s, v_{G_t})}}
    }{ v }{ p }
  }
  ...
  \inferrule[Conflict]{
    ...
    \applyAction{ \cursor{\conflictHole{t_i}_{i \leq n}} }{ v }{ p }{\alpha}{
