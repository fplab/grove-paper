...
\begin{mathpar}
  ...
  \inferrule{
    ...
    \act{v}{p}{
      ...
      \graphAction{\Minus}{\e};
      \graphAction{\Plus}{(u', v, p, (u'', k))};
      \graphAction{\Plus}{(u''', (u'', k), p_k, v_{G_t})}
    }
  }
  ...
  \inferrule{
    ...
    \act{v}{p}{
      ...
      \graphAction{\Minus}{(u_1, v, p, v_{G_{t_1}})};
      \ldots;
      \graphAction{\Minus}{(u_n, v, p, v_{G_{t_n}})};
      \graphAction{\Plus}{(u, v, p, (u', k))};
    } \\
    \graphAction{\Plus}{(u_1', (u', k), p_k, v_{G_{t_1}})};
    \ldots;
    \graphAction{\Plus}{(u_n', (u', k), p_k, v_{G_{t_n}})}
  }
  ...
  \inferrule{
    ...
    \act{v}{p}{
      ...
      \graphAction{\Minus}{\e};
      \graphAction{\Plus}{(u', v_\alpha, p_\alpha, v_{G_t})}
    }
  }
