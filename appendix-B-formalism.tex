...
\begin{theorem}
  Let $G$ be a well sorted graph,
  $\alpha^{*}$ a sequence of well sorted user actions,
  $t$ a term such that $\recomp{t} \subseteq G$,
  and $(v, p)$ a cursor vertex and position corresponding to $t$.
  If $\act{v}{p}{\Z{t}}{\alpha^{*}}{a^{*}}$,
