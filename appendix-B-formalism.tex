...
\begin{mathpar}
  ...
  \inferrule[ConstructConflictMany]{
    \sources{G_t} = \SetOf{(v_{s_i}, p_{s_i})}_{i \leq n} \\
...
l    \defaultpos{k} = p_k \\
    ...
    \applyAction{
      \cursor[\e{=}(u_s, v_s, p_s, v_{G_t})]{t}
    }{\Construct{k}}{
      \graphAction{\Minus}{\e};
      \graphAction{\Plus}{(\fresh{u}_s, v_s, p_s, v_k{=}(\fresh{u}_k, k))};
      \graphAction{\Plus}{(\fresh{u}, v_k, p_k, v_{G_t})}
    }
  }
  ...
  \inferrule[ConstructConflict]{
    ...
    \applyAction{
      \cursor[(u_s, v_s, p_s, v_{G_t})]{t}
    }{\Construct{k}}{
      \graphAction{\Plus}{(\fresh{u}_s, v_s, p_s, (\fresh{u}_k, k))}
    }
  }
  ...
  \inferrule[Conflict]{
    \SetOf{\applyAction{\cursor[\Z{\e}]{t_i}}{\alpha}{a_i^{*}}}_{i \leq n}
  }{
    \applyAction{
      \cursor[\Z{\e}]{\conflictHole{t_i}_{i \leq n}}
    }{\alpha}{
