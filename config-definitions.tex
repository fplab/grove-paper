...
% \newcommand{\eid}[2]{\tensor*[_{\id{#1}}]{#2}{}}
...
%       \hat{\Theta} = (\hat{t}, \Theta) is a set of terms with a zippered term inside
...
\newcommand{\Reposition}[1]{\text{Reposition}\mathopen{}\left(#1\right)\mathclose{}}
