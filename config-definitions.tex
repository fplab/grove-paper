...
\newcommand{\conflictHole}[4][]{%
{\noexpandarg\StrSubstitute{#2}{,}{\textcolor{red}{\,\textbf{|}\,}}[\myargs]%
{\textcolor{red}{\textbf{\{}}\myargs\textcolor{red}{\textbf{\}}}_{#1}^{\id{(#3, #4)}}}}}%
...
% helpers
\newcommand{\inedges}[1]{\text{inedges}\mathopen{}\left(#1\right)\mathclose{}}
\newcommand{\sources}[1]{\text{sources}\mathopen{}\left(#1\right)\mathclose{}}
\newcommand{\live}[1]{\text{live}\mathopen{}\left(#1\right)\mathclose{}}
\newcommand{\livesources}[1]{\text{livesources}\mathopen{}\left(#1\right)\mathclose{}}
...
\newcommand{\children}[2]{\childrenOp\mathopen{}\left(#1, #2\right)\mathclose{}}
