...
\newcommand{\applyActionX}[5]{#1; #2 \action{#3} #4; #5}
...
% helpers
\newcommand{\edges}[1]{\text{edges}\mathopen{}\left(#1\right)\mathclose{}}
...
\newcommand{\CSourceVertex}[3]{\text{SourceVertex}\mathopen{}\left(#1, #2, #3\right)\mathclose{}}
\newcommand{\CSourceEdge}[3]{\text{SourceEdge}\mathopen{}\left(#1, #2, #3\right)\mathclose{}}
