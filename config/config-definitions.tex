...
% {\textcolor{red}{\{}\myargs\textcolor{red}{\}}_{#1}}}}%

\newcommand{\genericConstructorTerm}[3]{\eid{#1}{#2}\ {\textbf{\{} #3 \textbf{\}}}_{p \in arity(k)}}
\newcommand{\genericTerm}[2]{\genericConstructorTerm{#1}{k}{#2}}

\newcommand{\conflictHole}[1]{{\textcolor{red}{\textbf{\{}}} #1 {\textcolor{red}{\textbf{\}}}}}

\newcommand{\binaryConflictHole}[2]{\conflictHole{#1 {\textcolor{red}{\textbf{|}}} #2}}

\newcommand{\conflictHoleTerm}[2]{\eid{#1}{} \conflictHole{#2} }

% \eid{#1}{}  #2 % {\textcolor{red} a}

% }
% {\noexpandarg\StrSubstitute{#3}{,}{\textcolor{red}{\,\textbf{|}\,}}[\myargs]%
% {\textcolor{red}{\textbf{\{}}\myargs\textcolor{red}{\textbf{\}}}_{#2}}}}%
\newcommand{\emptyHole}[1]{{}^{\id{#1}}\square}

\newcommand{\eVar}[2]{\eid{#1}{#2}}
\newcommand{\eFun}[4]{\eid{#1}{\lambda} #2 : #3 . #4}
\newcommand{\eApp}[3]{\eid{#1}{(#2~#3)}}
...
\newcommand{\num}{\eNum{u}{n}}
\newcommand{\ehole}{\emptyHole{\ell}}
\newcommand{\lexp}[1]{\eid{w}{}{#1}}
\newcommand{\conflict}[1]{
\conflictHoleTerm{\ell}{\eid{w_i}{}{#1}_{i}}_{i<n}
}
...
\newcommand{\provErase}[1]{#1\mathclose{}^{\circ}\mathclose{}}
...
\newcommand{\Construct}[1]{\mathsf{Construct}\mathopen{}\left(#1\right)\mathclose{}}
\newcommand{\Delete}{\mathsf{Delete}}
\newcommand{\Relocate}[1]{\mathsf{Relocate}\mathopen{}\left(#1\right)\mathclose{}}
\newcommand{\Wrap}[2]{\mathsf{Wrap}\mathopen{}\left(#1, #2\right)\mathclose{}}

% cursors
\newcommand{\CVertex}[1]{\text{Vertex}\mathopen{}\left(#1\right)\mathclose{}}
\newcommand{\CLocation}[1]{\text{Location}\mathopen{}\left(#1\right)\mathclose{}}
