...
\[
  \begin{array}{l}
    ...
    \left\{
      \begin{array}{ll}
        \conflictHoleForm{\edecomp{\e_i}}{i \leq n} &
          \outedges{v'}{p'} = \SetOf{\e_1, \ldots, \e_n}
        \\
        \multiVertex{\e'} &
          \outedges{v'}{p'} = \SetOf{(u_1, v_1, p_1, v_1')}
          \land |\parents{v_1'}| > 1
        \\
        \cycleVertex{\e'} &
          \outedges{v'}{p'} = \SetOf{(u_1, v_1, p_1, v_1')}
...
\[
  \begin{array}{l}
    ...
    \left\{
      \begin{array}{ll}
        \conflictHoleForm{\pdecomp{\e_i}}{i \leq n} &
          \outedges{v'}{p'} = \SetOf{\e_1, \ldots, \e_n}
        \\
        \multiVertex{\e'} &
          \outedges{v'}{p'} = \SetOf{(u_1, v_1, p_1, v_1')}
...
\[
  \begin{array}{l}
    ...
    \left\{
      \begin{array}{ll}
        \conflictHoleForm{\tdecomp{\e_i}}{i \leq n} &
          \outedges{v'}{p'} = \SetOf{\e_1, \ldots, \e_n}
        \\
        \multiVertex{\e'} &
          \outedges{v'}{p'} = \SetOf{(u_1, v_1, p_1, v_1')}
