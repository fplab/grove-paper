...
\newcommand{\figureDecompositionDefDecompComponents}{%
  NP &= \SetOf{\edecomp{(u, v, p, v')} \SuchThat{|\parents{v'}| = 0}} \\
  MP &= \SetOf{\edecomp{(u, v, p, v')} \SuchThat{|\parents{v'}| > 1}} \\
  U &= \SetOf{\edecomp{(u, v, p, v')} \SuchThat{|\parents{v'}| = 1 \land v' = \min{\ancestors{v'}}}}%
}
